      ...
      <div className={style.footerelements}>
        <div className="row">
          <div className="col-lg-4 col-md-6 col-sm-12">
            <div className={style.title}>Weekly Offers</div>
            <form>
              <div className="mb-3">
                <input
                  type="text"
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            <div className={style.title}>Main Links</div>
            <div className={style.links}>
              <a href="#">Main</a>
              <a href="#">About the institute</a>
              <a href="#">Connect with us</a>
              <a href="#">IELTS preperation course</a>
              <a href="#">EMSAt preparatory course</a>
              <a href="#">ICDL preparatory course</a>
              <a href="#">Language courses</a>
              <a href="#">Management professional courses</a>
